...
import { ORGANIZATION_LOCATION_DATASOURCE } from '@common/datasources/organizations/types/organization-location-datasource';
...
export const CREATE_ORGANIZATION_USE_CASE = 'CreateOrganizationUseCase';
  ...
  implements IBaseUseCase<CreateOrganizationInput, CreateOrganizationOutput>
{
  constructor(
    ...
    @inject(ORGANIZATION_LOCATION_DATASOURCE)
